<?php
/*
ez_sql_pdo.php ozg修改版1.0  2011-04-17
查找修改过的部分请搜索ozg
*/
 ...
 */
  ...
  */
  ...
  //by ozg 2011-04-17
  function ezSQL_pdo($dsn='', $user = NULL, $password = NULL)
  {
  ...
  */
  ...
  //by ozg 2011-04-17
  function connect($dsn='', $user = NULL, $password = NULL)
  {
   global $ezsql_pdo_str; $return_val = false;
      
   // Must have a user and a password
   //必须有一个用户和密码？实在不明白这是什么理由
   /*if ( ! $dsn || ! $user || ! $password )
   {
   ...
   try 
   {
    //by ozg 2011-04-17 改成了传不传入用户密码都可以
    if($user && $password){
  ...
  */
  ...
  function query($query)
  {
   ...
   // Start timer
   //by ozg 2011-04-17
   //Call to undefined method 报错！不知道是什么问题
